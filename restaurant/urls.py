...
urlpatterns = [
    ...
    path('reports/menu-items/', views.menu_item_reports, name='menu_item_reports'),
    ...
    path('restaurant/printserverorder/', views.printserverorder, name='printserverorder'),
    path('site-orders/feed/', views.site_orders_feed, name='site_orders_feed'),
    # path('getcommandesfromserver', views.getcommandesfromserver, name='getcommandesfromserver')
    # path('getcommandesfromserver', views.getcommandesfromserver, name='getcommandesfromserver')
    # path('getcommandesfromserver', views.getcommandesfromserver, name='getcommandesfromserver')
    # path('getcommandesfromserver', views.getcommandesfromserver, name='getcommandesfromserver')
